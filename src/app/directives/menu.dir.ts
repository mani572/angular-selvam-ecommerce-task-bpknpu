...
@Component({
  selector : 'menu',
  template : `
  <nav class="navbar navbar-expand-lg navbar-light bg-light d-print-none nav-p">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link"  (click)="cartDialog = !cartDialog">Your Order</a>
      </li>  

      <li class="nav-item">
        
<div (click)="cartDialog = !cartDialog">
...
<app-cartmodal [(visible)]="cartDialog">
	<h1>Your Order</h1>
  <cart></cart>
	<button (click)="cartDialog = !cartDialog" class="btn">Close</button>
</app-cartmodal>
